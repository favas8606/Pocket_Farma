// ignore_for_file: use_build_context_synchronously, avoid_print, camel_case_types, unused_field, non_constant_identifier_names
...
class SignUpPageState extends State<signUpPage> {
  ...
  Future uploadFileToDoctor() async {
    final path = 'file/Doctor/${nameController.text}/${_DoctorFile!.name}';
  ...
  Future uploadFileToDistributers() async {
    final path =
        'file/Distributers/${nameController.text}/${_DistributerFile!.name}';
      ...
      await http.post(
        ...
        body: jsonEncode(<String, dynamic>{
          ...
          "notification": <String, dynamic>{
            'title': 'Hello Pocket Pharma',
            'body':
                'New Dr ${nameController.text} is joined verify his documnet',
  ...
  void sendPushMessageForDistributer(token, body, title) async {
    try {
      await http.post(
        Uri.parse('https://fcm.googleapis.com/fcm/send'),
        headers: <String, String>{
        ...
        body: jsonEncode(<String, dynamic>{
          ...
          "notification": <String, dynamic>{
            'title': 'Hello Pocket Pharma',
            'body':
                'New Medical Distributer ${nameController.text} is joined verify his documnet',
            'android_channel_id': 'dbfood',
          },
          'to': token,
        }),
