      ...
      body: Padding(
        ...
        child: ListView(
          children: const [
            ...
            Text("Pocket Pharma takes the privacy of your information seriously.This privacy notice" +
                "Privacy Notice" +
            ...
            Text(
                'We receive and store any information you enter on our  mobile application or give us in any other way'),
            Text(
              '4.MINORS',
              style: TextStyle(
                fontSize: 22,
            ...
            Text(
                'Our mobile application do not offer services for use by minors. If you are under 18, you may use our website or mobile application only with the involvement of a parent or guardian.'),
            Text(
              '5.SHARING OF DATA',
              style: TextStyle(
                fontSize: 22,
