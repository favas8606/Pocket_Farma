...
import 'package:pocket_farma/Admin/NavigationBar.dart';
import 'package:pocket_farma/Screen/Location/Map.dart';
import 'package:pocket_farma/Screen/homePage.dart';
import 'package:shared_preferences/shared_preferences.dart';
// import 'package:geolocator/geolocator.dart';

class AddminLocation extends StatefulWidget {
  const AddminLocation({Key? key}) : super(key: key);

  @override
  State<AddminLocation> createState() => _AddminLocationState();
}

class _AddminLocationState extends State<AddminLocation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      endDrawer: const NavigationBarForAdmin(),
      appBar: AppBar(
        leading: IconButton(
